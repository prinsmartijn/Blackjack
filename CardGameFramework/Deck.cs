...
namespace BlackJack.CardGameFramework
{
    public class Deck
    {
        ...
        /// <summary>
        /// One complete deck with every face value and suit, consists of 52 cards (4(suits)x13(cards))
        /// </summary>
        public Deck()
        {
            foreach (Suit suit in Enum.GetValues(typeof(Suit))) //4x
            {
                foreach (FaceValue faceVal in Enum.GetValues(typeof(FaceValue))) //x13
                {
